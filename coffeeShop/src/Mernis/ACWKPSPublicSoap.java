...
public class ACWKPSPublicSoap
{
    ...
    public ACWKPSPublicSoap(){}

    public ACWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ACWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ACWExtendedSoapSerializationEnvelope envelope= new ACWExtendedSoapSerializationEnvelope(ACWExtendedSoapSerializationEnvelope.VER11);
