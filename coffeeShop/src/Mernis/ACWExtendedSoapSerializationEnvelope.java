...
public class ACWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ACWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ACWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ACWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ACWDateTimeConverter dateTimeConverter = new ACWStandardDateTimeConverter();

    public ACWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ACWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ACWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ACWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ACWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ACWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
